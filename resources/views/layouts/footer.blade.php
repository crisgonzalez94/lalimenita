    ...
    <div data-elementor-type="wp-post" data-elementor-id="3725" class="elementor custom-css-style"
        ...
        <div class="elementor-inner">
            <div class="elementor-section-wrap">
                                    ...
                                    <div class="elementor-widget-wrap">
                                        <div class="elementor-element elementor-element-c795a27 elementor-widget elementor-widget-heading"
                                            ...
                                            <div class="elementor-widget-container">
                                                <h2 class="elementor-heading-title elementor-size-default">VISITA
                                                    NUESTRAS REDES</h2>
                                            </div>
                                            <div class="elementor-text-editor elementor-clearfix">
                                                <p style="color: white;">
                                                    Entérate de sorteos y promociones.
                                                </p>
                                            </div>
                                            <div class="elementor-text-editor elementor-clearfix">
                                                <div class="elementor-social-icons-wrapper elementor-grid" style="display: flex;">
                                                    ...
                                                    <div class="elementor-grid-item">
                                                        <a href="https://www.instagram.com/sandwicheria.lalimenita" class="elementor-icon elementor-repeater-item-fac257c" target="_blank">
                                                    ...
                                                    <!--Whatsapp-->
                                                    <div class="elementor-grid-item">
                                                        <a href="https://api.whatsapp.com/send/?phone=56956245935&text&app_absent=0" class="elementor-icon elementor-repeater-item-fac257c" target="_blank">
                                                            <i class="bi bi-whatsapp" style="color: white; margin-right: 20px;"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <!--Logo Footer-->
                                        <div class="elementor-element elementor-element-bbbbc70 elementor-widget elementor-widget-image"  data-id="bbbbc70" data-element_type="widget"   data-settings='{"craftcoffee_ext_is_scrollme":"false","craftcoffee_ext_is_smoove":"false","craftcoffee_ext_is_parallax_mouse":"false","craftcoffee_ext_is_infinite":"false","craftcoffee_ext_is_fadeout_animation":"false"}'   data-widget_type="image.default">
                                            <!--Imagen de pedidos ya-->
                                            <div class="elementor-widget-container">
                                                <div class="elementor-image">
                                                    <img width="350" height="49" src="assets/images/pedidosya.svg" class="attachment-full size-full" alt="" loading="lazy" />
                                                </div>
                                            </div>
                                        </div>
                                        <!------>
                                ...
                                <div class="elementor-column-wrap elementor-element-populated">
                                    <div class="elementor-widget-wrap">
                                        <div class="elementor-element elementor-element-8af6019 elementor-widget__width-auto elementor-absolute elementor-widget elementor-widget-image"
                                            ...
                                            <!---Logo del medio footer-->
                                            <div class="elementor-widget-container">
                                                <div class="elementor-image">
                                                    <img width="340" height="340" src="assets/images/logo.png"
                ...
                <!--Copyright-->
                <section style="background: rgb(240 , 34 ,109);"
                                ...
                                <div class="elementor-column-wrap elementor-element-populated">
                                    <div class="elementor-widget-wrap">
                                        <div class="elementor-element elementor-element-ebb6c30 elementor-widget elementor-widget-heading"
                                            ...
                                            data-widget_type="heading.default">
                                            <div class="elementor-widget-container">
                                                <h3 class="elementor-heading-title elementor-size-default">Página de
                                                    prueba - Cristiann Gonzalez - Desarrollador</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
